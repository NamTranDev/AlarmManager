 ...
 */
package tran.nam.domain.interactor.core;
...
public abstract class UseCase<T, Params> {
    ...
    public IRespository iRepository;

    public UseCase(IRespository iAppRepository, SchedulerProvider schedulerProvider) {
        this.disposables = new CompositeDisposable();
        this.schedulerProvider = schedulerProvider;
        this.iRepository = iAppRepository;
    }
    ...
    private void addDisposable(Disposable disposable) {
        Checker.checkNotNull(disposable);
        Checker.checkNotNull(disposables);
