 ...
 */
//@Widget
@SuppressWarnings({"unused", "ManualArrayCopy", "UnusedReturnValue"})
public class NumberPicker extends LinearLayout {
    ...
    /**
     * The the durationMinute for adjusting the selector wheel.
     */
    private static final int SELECTOR_ADJUSTMENT_DURATION_MILLIS = 800;

    /**
     * The durationMinute of scrolling while snapping to a given position.
     */
     ...
     */
    private long mPreviousScrollerY;
    /**
    ...
    private boolean moveToFinalScrollerPosition(Scroller scroller) {
        ...
        long amountToScroll = scroller.getFinalY() - scroller.getCurrY();
        long futureScrollOffset = (mCurrentScrollOffset + amountToScroll) % mSelectorElementHeight;
        long overshootAdjustment = mInitialScrollOffset - futureScrollOffset;
    ...
    public void computeScroll() {
        ...
        long currentScrollerY = scroller.getCurrY();
        if (mPreviousScrollerY == 0) {
            mPreviousScrollerY = scroller.getStartY();
        }
        scrollBy(0, (int) (currentScrollerY - mPreviousScrollerY));
