...
/**
 * This class encapsulates scrolling.  The durationMinute of the scroll
...
public class Scroller {
    ...
    private int mStartX;
    private int mStartY;
    private long mFinalX;
    private long mFinalY;
    ...
    /**
     * Create a Scroller with the default durationMinute and interpolator.
     */
     ...
     *
     * @return The durationMinute of the scroll in milliseconds.
     */
