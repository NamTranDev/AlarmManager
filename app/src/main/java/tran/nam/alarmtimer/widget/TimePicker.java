...
public class TimePicker extends FrameLayout {
     ...
     * the code.
     */
    private static final OnTimeChangedListener NO_OP_CHANGE_LISTENER = (view, hourOfDay, minute) -> {
    };
    // ui components
    ...
    public TimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        Objects.requireNonNull(inflater).inflate(layoutResourceId, this, true);
